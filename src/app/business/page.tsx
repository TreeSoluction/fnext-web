    ...
    <div>
      ...
      <div className="flex flex-col justify-center items-center pt-40 text-center">
        ...
        <p className="text-xs m-2 max-w-96">
          Solicitaremos algumas informações essenciais para criar a página da
          sua franquia. Dessa forma, preencha todos os campos para passar maior
          credibilidade para o franqueado
        </p>
        <a
          href="/franchises/register"
          className="bg-MAIN_HIGH_BLUE my-5 p-2 px-16 rounded-full text-white line-clamp-4"
        >
          Começar
        </a>
