...
export default function Register() {
  ...
  const RegisterSchema = z.object({
    min_investment: z
      .string()
      .min(1, "Valor mínimo de investimento não pode ser vazio!"),
...
const RegisterFinanceFranchisehtmlForm = ({
  register,
  handleSubmit,
  onSubmit,
  errors,
      ...
      <div className="max-w-screen-xl m-auto">
        <div className="p-5 sm:px-36 pt-10 sm:pt-20 text-center">
          ...
          <p className="text-sm m-3 text-GRAY max-w-80 mx-auto">
            Dados financeiros necessários para possíveis franqueados franqueados
            empresa
          </p>
        ...
        >
          ...
          <div className="w-8/12">
            ...
            <ErrorMessage
              className="w-56"
              size="small"
              error={errors.model_business}
            />
          </div>
          <FieldFranchise />
          <div className="w-8/12">
            <p>Segmento de atuação</p>
            <select className="w-60 my-2 rounded-md bg-PASTEL p-2 border-none">
              <option value="">Escolha uma opção</option>
              <option value="Alimentação">Alimentação</option>
              <option value="Vestuário e Acessórios">
                Vestuário e Acessórios
              </option>
              <option value="Beleza e Estética">Beleza e Estética</option>
              <option value="Saúde e Bem-Estar">Saúde e Bem-Estar</option>
              <option value="Educação e Treinamento">
              ...
              <option value="Saúde e Serviços Médicos">
                Saúde e Serviços Médicos
              </option>
              <option value="Serviços Financeiros">Serviços Financeiros</option>
              <option value="Casa e Construção">Casa e Construção</option>
              <option value="Tecnologia da InhtmlFormação">
                Tecnologia da InhtmlFormação
              </option>
              <option value="Comunicação e Marketing">
                Comunicação e Marketing
              </option>
              <option value="Lazer e Entretenimento">
                Lazer e Entretenimento
              </option>
              <option value="Pet Shop e Serviços para Animais">
                Pet Shop e Serviços para Animais
              </option>
              <option value="Serviços Residenciais e RehtmlForma">
                Serviços Residenciais e RehtmlForma
              </option>
              <option value="Moda e Estilo de Vida">
                Moda e Estilo de Vida
              </option>
              <option value="Bebidas">Bebidas</option>
              <option value="Agências de Viagens e Turism">
                Agências de Viagens e Turism
              </option>
...
const RegisterMainFranchisehtmlForm = ({
  register,
  handleSubmit,
  onSubmit,
  errors,
    ...
    <>
      <div className="max-w-screen-xl m-auto">
        ...
        >
          ...
          <div className="w-10/12">
            <p>
              Videos sobre a empresa:{" "}
              <span className="text-xs text-GRAY">(URL)</span>
            </p>
            <InputStyled
    ...
    <div className="w-10/12 rounded-3xl overflow-hidden shadow-xl border-2 py-5 sm:p-10">
      <div className="w-full max-w-[25rem] m-auto">
        ...
        <div className="text-center mb-2">
          <input
            onChange={() => handleInputCheckBox(0)}
            type="checkbox"
            name=""
            id=""
          />
        ...
        <div className="text-center mb-2">
          <input
            onChange={() => handleInputCheckBox(1)}
            type="checkbox"
            name=""
            id=""
          />
        ...
        <div className="text-center mb-2">
          <input
            onChange={() => handleInputCheckBox(2)}
            type="checkbox"
            name=""
            id=""
          />
