...
export default function Home() {
    return (
     <>
        ...
        <img height={130} width={130} src={ICONS.models.set_up} alt="Set Up" />
     
        </div>
            <div className=""></div>
            <div className="flex flex-col text-center">
                <h2 className="flex flex-col -ml-6 -mr-8 pt-4 pb-4 text-xl font-bold">Agradecemos por finalizar seu cadastro. <br /> Em pouco tempo, sua página estará pronta <br /> para captar franqueados com fenext !</h2>
                <p className="pt-2 pb-16">Fique tranquilo, te avisaremos quando estiver tudo pronto.</p>
            </div> 
