        ...
        <div className="flex flex-col w-full max-w-md p-6 sm:px-12 sm:py-10 bg-white rounded-[5px] sm:rounded-[10px]  shadow-xl  bg-gray-200">
          ...
          <div className="flex flex-col text-center">
            <h2 className="flex flex-col text-2xl font-bold">
              Precisamos de alguns dados <br /> para criar a página da sua
              franquia.
            </h2>
          ...
          <div className=" flex flex-col w-full items-center justify-center  gap-2">
            ...
            <button
              className="mx-auto w-80 min-w-40  bg-white hover:bg-zinc-300 text-LOW_BLUE  text-xl py-2 rounded-[5px]  bg-zinc-200"
              type="submit"
            >
              {" "}
              Criar depois
