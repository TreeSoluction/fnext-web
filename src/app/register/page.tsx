    ...
    <div className="flex w-full min-h-screen bg-gradient-to-r from-GRAY to-LOW_PURPLE items-center justify-center px-2 py-20">
      ...
      >
        ...
        <p className="max-w-80 text-xs mt-8">
          Ao clicar em <strong>&quot;Finalizar&quot;</strong> e continuar com o seu cadastro, você está concordando com a nossa <a className="text-BLACK underline font-bold" href="#">Política de Privacidade</a>.
        </p>
