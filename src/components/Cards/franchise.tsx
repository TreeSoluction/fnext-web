...
export default function FranchiseCard({ name, description, image, value, segment }: FranchiseCardProps) {
    return (
        <div className="flex flex-col items-center text-center relative p-2 gap-2 w-72 rounded-2xl m-4">
            ...
            <div className="w-11/12">
                <span className="block w-3/5 text-xs  font-medium p-px text-center bg-slate-200 text-slate-800 rounded-md">{segment}</span>
            </div>
            ...
            <div className="flex justify-between w-11/12 text-[8px] text-MAIN_HIGH_BLUE font-bold mt-6">
                <div className="flex gap-4">
                    <div className="flex flex-col items-center">
                        <Image width={15} height={15} src={ICONS.segments.finances} alt="" />
                        <span>Financeiro</span>
                    </div>
                    <div className="flex flex-col items-center">
                        <Image width={15} height={15} src={ICONS.models.home_based} alt="" />
